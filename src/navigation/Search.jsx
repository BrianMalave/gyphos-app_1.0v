      ...
      try {
        (async () => {
          ...
          const res = await fetch(
            `${urlSearch}?api_key=${apiKey}&q=(encodeURI(${filter}))&limit=${qty}&offset=0&rating=g&lang=en`
          );
      ...
      >
        <div className="search_container">
          <input
            ...
            className={mode ? "night_mode" : "day_mode"}
            type="search"
          ...
          <button className="btn">
            <img
              ...
              src="/assets/icons/icon-search-mod-noc.svg"
              alt="icon-search"
            />
          </button>
        </div>
